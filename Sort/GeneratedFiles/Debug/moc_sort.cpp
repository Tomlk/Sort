...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Sort_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 17, 11)
    ...
    "Sort\0OnBt_start\0\0OnBt_create"
};
...
void Sort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: { int _r = _t->OnBt_start();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 1: { int _r = _t->OnBt_create();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        default: ;
        }
    }
...
const QMetaObject Sort::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Sort.data,
      qt_meta_data_Sort,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Sort.stringdata))
